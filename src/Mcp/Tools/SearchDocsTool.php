...
class SearchDocsTool extends Tool
{
     ...
     */
    protected string $description = 'Search the Laravilt Actions documentation to understand features, API, and usage';
    ...
    public function handle(Request $request): Response
    {
        ...
        $actionsPath = base_path('packages/laravilt/actions');

        // Collect all documentation files
        $docFiles = $this->getDocumentationFiles($actionsPath);
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'query' => $schema->string()
                ->description('Search query (e.g., "modal", "authorization", "variants", "colors")')
                ->required(),
        ];
    }
