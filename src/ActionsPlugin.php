...
class ActionsPlugin extends PluginProvider implements Plugin
{
    /**
     * The plugin ID (must be unique).
     */
    protected static string $id = 'actions';
     ...
     */
    protected static string $description = 'Pre-built, fully customizable components for Inertia.js, seamlessly integrated with a PHP backend and Laravel framework. This package is optimized for high-end performance and compatibility with FilamentPHP v4, providing a powerful solution for building modern, reactive web applications.';
